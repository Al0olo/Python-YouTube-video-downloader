...
# ================tkinter window
root = Tk()
root.title("Youtube Video downloader - By Abdallah Farag")
...
downloadButton = Button(root,
                        text="Download", width=20, bg="green",font=18,fg="white",
...
loadingLabel = ttk.Label(root, text="App developed by >> Abdallah Farag",
                         font=("Agency FB", 20))
loadingLabel.grid()
